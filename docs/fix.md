...
-   리쿠르팅 페이지 - 노하림, 김예지 개발자
    ...
    -   **1월 18일까지 반영사항**
        - [ ] 리크루팅 네브바의 ‘중앙 운영단 지원’ 버튼 랜딩페이지를 변경해주세요. 
...
-   참여대학 페이지 - 노하림, 김예지 개발자
    ...
    -   **1월 18일까지 반영사항**
        - [ ] 서울대학교 랜딩페이지 링크를 변경해주세요. https://www.snulion.com/
...
-   프로젝트 페이지 - 한영준, 김진호 개발자
    ...
    -   **1월 18일까지 반영사항**
        - [ ] 프로젝트 네브바 한양대 이미지 대체 (애초에 등록이 안 되어있는 것 같습니다..)
...
-   커뮤니티 페이지 - 김예린 개발자
    ...
    -   [ ] 커뮤니티 메인페이지 모바일 반응형 적용
    -   [ ] 게시글 작성 페이지 모바일 반응형 적용
    -   [ ] 게시글 상세 페이지 모바일 반응형 적용
