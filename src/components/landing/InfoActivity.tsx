...
const InfoActivity = () => {
  return (
    <>
        <IF.Box background="#FF7710" hoverBackColor='linear-gradient(180deg, rgba(255, 119, 16, 0.30) 0%, rgba(255, 119, 16, 0.00) 100%)'>
            <div className='title'>
        ...
        <IF.Box background="#C6F959" hoverBackColor='linear-gradient(180deg, rgba(198, 249, 89, 0.30) 0%, rgba(198, 249, 89, 0.00) 100%)'>
            <div className='title'>
