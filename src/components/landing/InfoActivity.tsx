...
const trackArray: any[] = [
  {
    ...
    image: frontEndImage,
    imageMobile: frontEndImageMobile,
    imageSmallMobile: frontEndsmallImageMobile,
  },
  {
    hoverColor: "#212224",
    initialColor: "#FF7710",
    ...
    image: backEndImage,
    imageMobile: backEndImageMobile,
    imageSmallMobile: backEndsmallImageMobile,
  },
  
  {
    ...
    image: designImage,
    imageMobile: DesignImageMobile,
    imageSmallMobile: DesignsmallImageMobile, 
  },
  {
    hoverColor: "#212224",
    initialColor: "#ADB3BA",
    ...
    image: planningImage,
    imageMobile: planningImageMobile,
    imageSmallMobile: planningsmallImageMobile,
...
const InfoTrack = () => {
  ...
  const handleMouseEnter = (index: number) => {
    ...
    if (trackBox) {
      trackBox.style.color = trackArray[index].initialColor;
    }
  };
  ...
  return (
    <IF.TrackWrapper>
      {trackArray.map((item, index) => (
        <IF.TrackBox
          key={index}
          backgroundColor={item.initialColor}
