...
const Header: React.FC<HeaderProps> = ({
        ...
        try {
            if (isFollowed) {
                await axiosInstance.delete(
                    `/api/v1/follow/${postData.authorId}`,
                );
            } else {
    ...
    return (
        <>
            ...
            <D.User>
                <div className="left">
                    <img src={`https://${profileImageUrl}`} alt="" className="image" />
                    <div>
                        ...
                        <div className="userInfo">
                            <p>{postData.authorOrdinal}기</p>
                            <D.Dot />
                            <p>{postData.universityName}</p>
                            <D.Dot />
                ...
                <div className="right">
                    ...
                    {isMyPost && (
                        <div className="btns">
                            <p className="delete" onClick={onDeletePost}>
                                삭제하기
                            </p>
                            <p className="modify" onClick={onModifyPost}>
                                수정하기
                            </p>
                        </div>
                    )}
