  ...
  return (
    <D.Wrapper>
        ...
        <D.Container>
            ...
            <D.PeopleBox>
                <DevInfo name='이태휘' from='홍익대학교 11기 대표' position='PM'/>
            </D.PeopleBox>
            <D.Divider/>
            <p className='part'>PM</p>
            <D.PeopleBox>
                <DevInfo name='변주현' from='중앙대학교 11기 대표' position='PM 파트장'/>
            </D.PeopleBox>
            <D.Divider/>
            ...
            <D.PeopleBox>
                ...
                <DevInfo name='한영준' from='한국외국어대학교 서울캠퍼스 11기 대표' />
            </D.PeopleBox>
            <D.Divider/>
            <p className='part'>Backend</p>
            <D.PeopleBox>
                <DevInfo name='김슬기' from='홍익대학교 11기 운영진' position='백엔드 파트장'/>
                <DevInfo name='황제철' from='한국항공대학교 11기 대표' position='백엔드 파트장'/>
                
                <DevInfo name='김민석' from='상명대학교 천안캠퍼스 11기 대표 '/>
