...
export const tabData: { [key: string]: ITabData[] } = {
    서울: [
        { school: '강남대학교', region: '서울' },
        { school: '국민대학교', region: '서울' },
        { school: '단국대학교', region: '서울' },
        { school: '동국대학교', region: '서울' },
        { school: '동덕여자대학교', region: '서울' },
        { school: '상명대학교(서울)', region: '서울' },
        { school: '성공회대학교', region: '서울' },
        { school: '서강대학교', region: '서울' },
        { school: '연세대학교', region: '서울' },
        { school: '고려대학교(안암)', region: '서울' },
         { school: '숙명여자대학교', region: '서울' },
         { school: '숭실대학교', region: '서울' },
         { school: '중부대학교', region: '서울' },
         { school: '한국외국어대학교(서울)', region: '서울' },
         { school: '한성대학교', region: '서울' },
         { school: '건국대학교', region: '서울' },
         { school: '광운대학교', region: '서울' },
         { school: '덕성여자대학교', region: '서울' },
         { school: '서경대학교', region: '서울' },
         { school: '서울대학교', region: '서울' },
         { school: '명지대학교(서울)', region: '서울' },
         { school: '삼육대학교', region: '서울' },
         { school: '성신여자대학교', region: '서울' },
         { school: '이화여자대학교', region: '서울' },
         { school: '한양여자대학교', region: '서울' },
    ],
    부산: [
