...
function UserEnrolled() {
  const {userLength, planUser, designUser, frontendUser, backendUser, removePlanUser, removeDesignUser, removeFrontendUser, removeBackendUser} = useEnrolledUser();  
  ...
  return (
    <UE.Container show={userLength > 0}>
      ...
      <Part name='프론트엔드' user={frontendUser} remove={removeFrontendUser} />
