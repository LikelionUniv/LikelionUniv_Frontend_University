    ...
    return (
        <ProjectRoot>
            ...
            <ProjectMainDescription>
                ...
                <PaletteContainer>
                    <P>
                        Palette은 오늘 하루에 대해 떠오르는 색을 선택하여,
                        기억하고 싶은 순간들을 기록하는 아카이빙 서비스입니다.
                    </P>
                    <P>
                        1) Palette를 통해 사용자가 그날 느꼈던 감정이나 분위기를
                        더 생생하게 기억하고 특별하게 추억할 수 있게 합니다.
                    </P>
                    <P>
                        2) 기록의 시작과 끝에 색 이미지를 부여해 사용자에게
                        특별한 기록 경험을 제공하고 사용자 고유의 아카이브를
                        소장할 수 있게 합니다.
                    </P>
                    <P>
                        3) 한정된 단어로는 형용하는 데에 한계가 있는 사람의
                        감정을 다채로운 색을 통해 다양한 형태로 표현 할 수
                        있습니다.
                    </P>
                </PaletteContainer>
            </ProjectMainDescription>
